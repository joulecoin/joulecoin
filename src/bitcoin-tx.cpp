...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Joulecoin Core joulecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  joulecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded joulecoin transaction") + "\n" +
              "  joulecoin-tx [options] -create [commands]   " + _("Create hex-encoded joulecoin transaction") + "\n" +
              "\n";
