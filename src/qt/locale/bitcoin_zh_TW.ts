...
<context>
    ...
    <message>
        ...
        <translation>開啓 joulecoin 協議的 URI 或付款要求</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Joulecoin Alert" admin@foo.com
        ...
        <translation>要使用 joulecoind, 或是對 joulecoin-qt 指定 -server 選項，你必須要在以下設定檔中設定 RPC 密碼(選項: rpcpassword):
%s
建議你使用以下隨機產生的密碼:
rpcuser=joulecoinrpc
rpcpassword=%s
...
比如說設定: alertnotify=echo %%s | mail -s "Joulecoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>RPC SSL 選項: (SSL 設定程序請見 Joulecoin Wiki)</translation>
    </message>
    <message>
