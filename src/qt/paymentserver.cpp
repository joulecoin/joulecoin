...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click joulecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start joulecoin: click-to-pay handler");
    else
...
{
    // clicking on joulecoin: URLs creates FileOpen events on the Mac:
